...
- `thesis/thesis_master.md`: thesis chapter map, evidence bindings, and figure numbering
...
- `data_reproducibility.md`: pinned inputs and refetch policy
- `reproducibility_checklist.md`: reviewer verification path
- `national_data_integration_plan.md`: accommodation and e-Stat scope
- `adr/`: architecture and research-design decisions
  - `adr/0027-nonsurvey-scope-boundary.md`: scope boundary for non-survey SEM and opportunity simulation
